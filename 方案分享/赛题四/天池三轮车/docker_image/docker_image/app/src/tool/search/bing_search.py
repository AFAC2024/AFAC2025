...
import sys
sys.path.append("/workspace/code/generate_report/FinGenius")
...
def XiaoxiangdailiProxy():
    # IP代理
    http_proxy = "http://836063038645096448:grjPvs5k@http-dynamic-S02.xiaoxiangdaili.com:10030"
    https_proxy = "http://836063038645096448:grjPvs5k@http-dynamic-S02.xiaoxiangdaili.com:10030"
...
class BingSearchEngine(WebSearchEngine):
    ...
    def _parse_html(
        ...
        """
        try:
            res = self.session.get(url=url, proxies=XiaoxiangdailiProxy())
            res.encoding = "utf-8"
...
if __name__ == "__main__":
    ...
    results = engine.perform_search("Python", 10)
